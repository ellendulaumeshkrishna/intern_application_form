...
//     AxiosInstance.post('api/registerform/', formData,{
//       headers: {
...
const theme = createTheme({
  palette: {
    primary: {
      main: '#8b0000'  // Deep maroon instead of default blue
    }
  }
});
      ...
      <form onSubmit={handleSubmit(submission)}>
        ...
        <Box
          sx={{
            ...
            padding: 4,
            marginTop: 2,
            backgroundColor: '#fffdf5', // Light Beige background for form sections
            borderRadius: '8px',
        ...
        <Box sx={{ marginTop: '20px', display: 'flex', justifyContent: 'center' }}>
          <Button
            ...
            sx={{
              width: '15%',
              height: '40px',
              backgroundColor: '#8b0000', // Maroon color for button
